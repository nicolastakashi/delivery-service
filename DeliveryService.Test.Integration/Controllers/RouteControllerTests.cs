...
namespace DeliveryService.Test.Integration.Controllers
{
    ...
    public class RouteControllerTests : BaseControllerTests
    {
        private readonly string _resource = "/api/routes";
        private static string _id = string.Empty;

        public RouteControllerTests(ServiceContainersFixture fixture)
            : base(fixture)
        {
            LoginAsAdmin().Wait();
        }
        ...
        [Fact, Order(3)]
        public async void Get_Paged_Route_Success()
        {
        ...
        [Fact, Order(4)]
        public async void Put_Route_Success()
        {
